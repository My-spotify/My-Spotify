...
async function getsongs(folder) {
    ...
    let a = await fetch(`My-Spotify/tree/main/songs/${folder}`)
...
async function displayalbum(){
    ...
    let a = await fetch(`My-Spotify/tree/main/songs/`)
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (a.href.includes("/songs") && !a.href.includes(".htaccess")) {
            ...
            let b = await fetch(`My-Spotify/tree/main/songs/${folder}/info.json`)
